...
const PrimaryBar: FC = () => {
  return (
    <aside className='flex flex-col w-14 md:w-20 bg-sky-900 items-center text-white'>
      <NavLink
        href='/'
        onPageClassName='bg-sky-700'
        className='p-2 md:p-4 hover:bg-sky-700'>
        <HomeIcon className='w-8 md:w-12' />
      </NavLink>
      <div id='open-tx'>
        <OpenURL className='p-2 md:p-4 hover:bg-sky-700'>
          <FolderOpenIcon className='w-8 md:w-12' />
        </OpenURL>
      </div>
      <div id='config'>
        <ConfigModalButton className='p-2 md:p-4 hover:bg-sky-700'>
          <CogIcon className='w-8 md:w-12' />
        </ConfigModalButton>
      </div>
      <a className='p-2 md:p-4 hover:bg-sky-700' target='_blank' rel='noreferrer' href='https://discord.gg/BGuhdBXQFU'>
        <div className='w-8 md:w-12 aspect-square relative'>
          <Image src='/Discord-Logo-White.svg' fill alt='Discord Server' sizes='100%' />
        </div>
      </a>
      <a className='p-2 md:p-4 hover:bg-sky-700' target='_blank' rel='noreferrer' href='https://github.com/ADAOcommunity/round-table'>
        <svg className='w-8 md:w-12 fill-white' viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
